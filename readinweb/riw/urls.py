...
urlpatterns = [
    ...
    url(r'^users/register/$', views.UserRegister),
    ...
    url(r'^released_activities/$', views.Released_activityList.as_view()),
    url(r'^released_activities/(?P<pk>\d+)/$', views.Released_activityDetail.as_view()),
